    ...
    <div className="flex min-h-[calc(100vh-160px)] items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 bg-card/60 backdrop-blur-sm border border-border p-8 rounded-2xl shadow-sm">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight font-sora">Create your account</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Get started with 5 free credits upon successful authentication.
          </p>
        </div>
        ...
        {isSubmitted ? (
          <div className="flex flex-col items-center justify-center py-6 text-center animate-in fade-in-50">
            ...
            <p className="text-sm text-muted-foreground mt-2 max-w-[280px]">
              We sent a magic link to <span className="font-medium text-foreground">{email}</span>. Click the link to complete registration.
            </p>
            <Button
              variant="outline"
        ...
        <div className="mt-6 text-center text-sm border-t border-border/60 pt-4">
          ...
          <Link href="/signin" className="font-semibold text-[#F97316] hover:underline">
            Sign in
          </Link>
        </div>
      </div>
